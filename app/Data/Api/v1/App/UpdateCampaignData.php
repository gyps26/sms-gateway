...
class UpdateCampaignData extends BaseData
{
    public function __construct(
        #[In('Stalled', 'Succeeded', 'Failed', 'Cancelled')]
        public string $status,

        #[WithCast(DateTimeInterfaceCast::class, setTimeZone: 'UTC')]
        #[Date, RequiredIf('status', 'Stalled'), ProhibitedUnless('status', 'Stalled')]
        public ?Carbon $resumeAt,
    ) {}
