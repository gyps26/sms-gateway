...
class CampaignDeviceResource extends JsonResource
{
    ...
    #[ResponseField(name: 'status', type: 'string', description: 'The status of the campaign on the device.', enum: CampaignableStatus::class)]
    #[ResponseField(name: 'sims', type: 'object[]', description: 'The sims of the device that are used in the campaign.')]
