...
class WebhookCallPolicy
{
     ...
     */
    public function create(User $user, int $count = 1): Response
    {
        return $user->canConsume($count, 'credits');
    }
    ...
    public function resend(User $user, WebhookCall $webhookCall): bool
    {
        return $user->id === $webhookCall->webhook->user_id && $webhookCall->status === WebhookCallStatus::PermanentlyFailed;
    }
}
